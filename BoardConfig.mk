...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.biometrics.fingerprint@2.1-service.RM6785.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.health-service.RM6785.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.light-service.RM6785.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.neuralnetworks@1.3-service-mtk-dsp-gpu.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.power-service.RM6785.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.vibrator-service.RM6785.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.wifi.hostapd.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.wifi@1.0-service.RM6785.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/memtrack_default.xml
